const Header = {
  template: `
    <aside class="fixed left-0 top-0 h-full w-16 bg-white dark:bg-gray-800 shadow-lg border-r border-gray-200 dark:border-gray-700 z-40 hidden md:flex flex-col transition-all duration-300">
      <div class="p-3 border-b border-gray-200 dark:border-gray-700">
        <div class="flex justify-center">
          <img v-if="settings.appLogo" :src="settings.appLogo" :alt="settings.appName" class="w-8 h-8 object-contain">
          <svg v-else width="32" height="18" viewBox="0 0 46 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-gray-700 dark:text-gray-300">
  ...
  emits: ["delete-unused-images", "delete-all-done-tasks", "open-settings", "logout"],
  methods: {
    toggleDropdown() {
